...
public class CategoryDetailsClassificationAdapter extends BaseQuickAdapter<ComcateListsResponse.DataBean, BaseViewHolder> {

    public CategoryDetailsClassificationAdapter(int layoutResId) {
        super(layoutResId);
    }
