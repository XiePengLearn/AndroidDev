 ...
 */
public class PermitPresenter extends BasePresenter implements PermitContract.Presenter {
    private MainDataManager mDataManager;
    private              PermitContract.View mContractView;
    private static final String               TAG = "ChangeAuthenticationPresenter";

    @Inject
    public PermitPresenter(MainDataManager mDataManager, PermitContract.View view) {
