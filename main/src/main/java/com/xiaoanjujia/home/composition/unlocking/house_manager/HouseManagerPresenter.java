...
import com.xiaoanjujia.home.entities.HouseManagerResponse;
 ...
 */
public class HouseManagerPresenter extends BasePresenter implements HouseManagerContract.Presenter {
    private MainDataManager mDataManager;
    private              HouseManagerContract.View mContractView;
    private static final String               TAG = "ChangeAuthenticationPresenter";

    @Inject
    public HouseManagerPresenter(MainDataManager mDataManager, HouseManagerContract.View view) {
