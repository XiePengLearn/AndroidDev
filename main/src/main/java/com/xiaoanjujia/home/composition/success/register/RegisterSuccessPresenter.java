 ...
 * @Description:
 */
public class RegisterSuccessPresenter extends BasePresenter implements RegisterSuccessContract.Presenter {
    private MainDataManager mDataManager;
    private RegisterSuccessContract.View mLoginView;
    private static final String TAG = "MainPresenter";

    @Inject
    public RegisterSuccessPresenter(MainDataManager mDataManager, RegisterSuccessContract.View view) {
