 ...
 * data：16/7/27
 */
public class StaffGridImageAdapter extends
        RecyclerView.Adapter<StaffGridImageAdapter.ViewHolder> {
    private static final int TYPE_CAMERA = 1;
    private static final int TYPE_PICTURE = 2;
    private final StaffActivity mContext;
    ...
    StaffGridImageAdapter(StaffActivity context, onAddPicClickListener1 mOnAddPicClickListener) {
        mContext = context;
            ...
            viewHolder.llDel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (index != RecyclerView.NO_POSITION) {
                        list.remove(index);
                        StaffGridImageAdapter.this.notifyItemRemoved(index);
                        StaffGridImageAdapter.this.notifyItemRangeChanged(index, list.size());
                        if (list.size() == 0) {
