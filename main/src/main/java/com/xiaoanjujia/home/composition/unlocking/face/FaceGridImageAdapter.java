 ...
 * data：16/7/27
 */
public class FaceGridImageAdapter extends
        RecyclerView.Adapter<FaceGridImageAdapter.ViewHolder> {
    private static final int TYPE_CAMERA = 1;
    private static final int TYPE_PICTURE = 2;
    private final FaceActivity mContext;
    ...
    FaceGridImageAdapter(FaceActivity context, onAddPicClickListener mOnAddPicClickListener) {
        mContext = context;
            ...
            viewHolder.llDel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (index != RecyclerView.NO_POSITION) {
                        list.remove(index);
                        FaceGridImageAdapter.this.notifyItemRemoved(index);
                        FaceGridImageAdapter.this.notifyItemRangeChanged(index, list.size());
                        if (list.size() == 0) {
