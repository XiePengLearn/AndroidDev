 ...
 * @Description:
 */
public class AuditSuccessPresenter extends BasePresenter implements AuditSuccessContract.Presenter {
    private MainDataManager mDataManager;
    private AuditSuccessContract.View mLoginView;
    private static final String TAG = "MainPresenter";

    @Inject
    public AuditSuccessPresenter(MainDataManager mDataManager, AuditSuccessContract.View view) {
