 ...
 * 修改成功
 */
@Route(path = "/ModificationSuccessActivity/ModificationSuccessActivity")
public class ModificationSuccessActivity extends BaseActivity implements ModificationSuccessContract.View {
    @Inject
    ModificationSuccessPresenter presenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.modification_success_activity);
    ...
    private void initView() {
        ...
        DaggerModificationSuccessActivityComponent.builder()
                .appComponent(getAppComponent())
                .modificationSuccessPresenterModule(new ModificationSuccessPresenterModule(this, MainDataManager.getInstance(mDataManager)))
                .build()
                .inject(this);
