 ...
 * data：16/7/27
 */
public class ReservationRecordDetailGridImageAdapter extends
        RecyclerView.Adapter<ReservationRecordDetailGridImageAdapter.ViewHolder> {
    private static final int TYPE_CAMERA = 1;
    private static final int TYPE_PICTURE = 2;
    private final ReservationRecordDetailsActivity mContext;
    ...
    ReservationRecordDetailGridImageAdapter(ReservationRecordDetailsActivity context, onAddPicClickListener1 mOnAddPicClickListener) {
        mContext = context;
