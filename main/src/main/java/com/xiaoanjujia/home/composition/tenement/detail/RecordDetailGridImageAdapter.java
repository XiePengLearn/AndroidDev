 ...
 * data：16/7/27
 */
public class RecordDetailGridImageAdapter extends
        RecyclerView.Adapter<RecordDetailGridImageAdapter.ViewHolder> {
    private static final int TYPE_CAMERA = 1;
    private static final int TYPE_PICTURE = 2;
    private final RecordDetailActivity mContext;
    ...
    RecordDetailGridImageAdapter(RecordDetailActivity context, onAddPicClickListener1 mOnAddPicClickListener) {
        mContext = context;
