...
public class ChoiceRriginIncidentDialog extends Dialog {
    ...
    public ChoiceRriginIncidentDialog(@NonNull Context context, IncidentCallback genderCallback1) {
        super(context);
        mContext = context;
        this.genderCallback = genderCallback1;
        mView = LayoutInflater.from(context).inflate(R.layout.dialog_user_info_choice_origin_incident, null, false);
        ...
        takeOutSelectIv = mView.findViewById(R.id.dialog_choice_take_out_select_iv);
        ...
        mView.findViewById(R.id.dialog_choice_take_out_rl).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                genderCallback.genderSelect(INCIDENT_TAKE_OUT);
                selectIncident = INCIDENT_TAKE_OUT;
            }
        });
    ...
    private void choiceElseMethod(int p, int p2, int p3, int p4, int p5) {
        elseSelectIv.setImageResource(p);
        workSelectIv.setImageResource(p2);
        seeSelectIv.setImageResource(p3);
        takeOutSelectIv.setImageResource(p4);
    ...
    public void selectGender(int genderType) {
        if (genderType == INCIDENT_ELSE) {
            ...
            choiceElseMethod(R.drawable.shape_change_region_no_checked, R.drawable.shape_change_region_no_checked, R.drawable.shape_change_region_checked, R.drawable.shape_change_region_no_checked, R.drawable.shape_change_region_no_checked);
            selectIncident = genderType;
        } else if (genderType == INCIDENT_TAKE_OUT) {
            choiceElseMethod(R.drawable.shape_change_region_no_checked, R.drawable.shape_change_region_no_checked, R.drawable.shape_change_region_no_checked, R.drawable.shape_change_region_checked, R.drawable.shape_change_region_no_checked);
            selectIncident = genderType;
