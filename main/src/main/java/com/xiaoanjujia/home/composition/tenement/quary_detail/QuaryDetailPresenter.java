 ...
 */
public class QuaryDetailPresenter extends BasePresenter implements QuaryDetailContract.Presenter {
    private MainDataManager mDataManager;
    private QuaryDetailContract.View mContractView;
    private static final String TAG = "ChangeAuthenticationPresenter";

    @Inject
    public QuaryDetailPresenter(MainDataManager mDataManager, QuaryDetailContract.View view) {
