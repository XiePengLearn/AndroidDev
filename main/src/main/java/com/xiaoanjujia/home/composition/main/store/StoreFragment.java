...
public class StoreFragment extends BaseFragment implements StoreFragmentContract.View, PtrHandler {
    ...
    public static StoreFragment newInstance() {
        StoreFragment newInstanceFragment = new StoreFragment();
    ...
    public void initView() {
        ...
        DaggerStoreFragmentComponent.builder()
                .appComponent(getAppComponent())
                .storeFragmentModule(new StoreFragmentModule(this, MainDataManager.getInstance(mDataManager)))
                .build()
                .inject(this);
        //
