 ...
 */
public class SupervisorPresenter extends BasePresenter implements SupervisorContract.Presenter {
    private MainDataManager mDataManager;
    private              SupervisorContract.View mContractView;
    private static final String               TAG = "ChangeAuthenticationPresenter";

    @Inject
    public SupervisorPresenter(MainDataManager mDataManager, SupervisorContract.View view) {
