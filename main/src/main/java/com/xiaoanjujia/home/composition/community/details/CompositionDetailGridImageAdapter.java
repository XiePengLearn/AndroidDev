 ...
 * data：16/7/27
 */
public class CompositionDetailGridImageAdapter extends
        RecyclerView.Adapter<CompositionDetailGridImageAdapter.ViewHolder> {
    private static final int TYPE_CAMERA = 1;
    private static final int TYPE_PICTURE = 2;
    private final CompositionDetailActivity mContext;
    ...
    CompositionDetailGridImageAdapter(CompositionDetailActivity context, onAddPicClickListener1 mOnAddPicClickListener) {
        mContext = context;
