 ...
 * @Description:
 */
public class SubmitSuccessPresenter extends BasePresenter implements SubmitSuccessContract.Presenter {
    private MainDataManager mDataManager;
    private SubmitSuccessContract.View mLoginView;
    private static final String TAG = "MainPresenter";

    @Inject
    public SubmitSuccessPresenter(MainDataManager mDataManager, SubmitSuccessContract.View view) {
