 ...
 * @Description:
 */
public class InviteSuccessPresenter extends BasePresenter implements InviteSuccessContract.Presenter {
    private MainDataManager mDataManager;
    private InviteSuccessContract.View mLoginView;
    private static final String TAG = "MainPresenter";

    @Inject
    public InviteSuccessPresenter(MainDataManager mDataManager, InviteSuccessContract.View view) {
