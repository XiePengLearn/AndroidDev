 ...
 * data：16/7/27
 */
public class PostMessageGridImageAdapter extends
        RecyclerView.Adapter<PostMessageGridImageAdapter.ViewHolder> {
    ...
    PostMessageGridImageAdapter(PostMessageActivity context, onAddPicClickListener1 mOnAddPicClickListener) {
        mContext = context;
            ...
            viewHolder.llDel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (index != RecyclerView.NO_POSITION) {
                        list.remove(index);
                        PostMessageGridImageAdapter.this.notifyItemRemoved(index);
                        PostMessageGridImageAdapter.this.notifyItemRangeChanged(index, list.size());
                        if (list.size() == 0) {
