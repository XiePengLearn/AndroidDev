 ...
 */
public class VisitorAuditPresenter extends BasePresenter implements VisitorAuditContract.Presenter {
    private MainDataManager mDataManager;
    private              VisitorAuditContract.View mContractView;
    private static final String               TAG = "ChangeAuthenticationPresenter";

    @Inject
    public VisitorAuditPresenter(MainDataManager mDataManager, VisitorAuditContract.View view) {
