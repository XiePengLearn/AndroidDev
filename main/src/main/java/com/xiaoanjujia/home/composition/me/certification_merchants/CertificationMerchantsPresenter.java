 ...
 */
public class CertificationMerchantsPresenter extends BasePresenter implements CertificationMerchantsContract.Presenter {
    private MainDataManager mDataManager;
    private              CertificationMerchantsContract.View mContractView;
    private static final String               TAG = "ChangeAuthenticationPresenter";

    @Inject
    public CertificationMerchantsPresenter(MainDataManager mDataManager, CertificationMerchantsContract.View view) {
