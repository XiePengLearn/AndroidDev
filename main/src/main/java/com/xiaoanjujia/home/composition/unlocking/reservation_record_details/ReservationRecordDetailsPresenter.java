 ...
 */
public class ReservationRecordDetailsPresenter extends BasePresenter implements ReservationRecordDetailsContract.Presenter {
    private MainDataManager mDataManager;
    private              ReservationRecordDetailsContract.View mContractView;
    private static final String               TAG = "ChangeAuthenticationPresenter";

    @Inject
    public ReservationRecordDetailsPresenter(MainDataManager mDataManager, ReservationRecordDetailsContract.View view) {
