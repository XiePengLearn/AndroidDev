 ...
 * @Description:
 */
public class StoreFragmentPresenter extends BasePresenter implements StoreFragmentContract.Presenter {

    private MainDataManager mDataManager;

    private StoreFragmentContract.View mContractView;
    private static  final String         TAG = "BeforePagePresenter";
    @Inject
    public StoreFragmentPresenter(MainDataManager mDataManager, StoreFragmentContract.View view) {
