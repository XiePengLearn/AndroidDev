 ...
 * @Description:
 */
public class TenementFragmentPresenter extends BasePresenter implements TenementFragmentContract.Presenter {

    private MainDataManager mDataManager;

    private TenementFragmentContract.View mContractView;
    private static  final String         TAG = "BeforePagePresenter";
    @Inject
    public TenementFragmentPresenter(MainDataManager mDataManager, TenementFragmentContract.View view) {
