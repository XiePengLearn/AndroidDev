 ...
 * @Description:
 */
public class ModificationSuccessPresenter extends BasePresenter implements ModificationSuccessContract.Presenter {
    private MainDataManager mDataManager;
    private ModificationSuccessContract.View mLoginView;
    private static final String TAG = "MainPresenter";

    @Inject
    public ModificationSuccessPresenter(MainDataManager mDataManager, ModificationSuccessContract.View view) {
