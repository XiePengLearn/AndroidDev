...
import com.xiaoanjujia.home.composition.success.register.DaggerRegisterSuccessActivityComponent;
 ...
 * 邀约成功
 */
@Route(path = "/InviteSuccessActivity/InviteSuccessActivity")
public class InviteSuccessActivity extends BaseActivity implements InviteSuccessContract.View {
    @Inject
    InviteSuccessPresenter presenter;
    ...
    private void initView() {
        ...
        DaggerInviteSuccessActivityComponent.builder()
                .appComponent(getAppComponent())
                .inviteSuccessPresenterModule(new InviteSuccessPresenterModule(this, MainDataManager.getInstance(mDataManager)))
                .build()
                .inject(this);
