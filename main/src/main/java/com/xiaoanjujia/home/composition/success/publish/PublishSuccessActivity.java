 ...
 * 发布成功
 */
@Route(path = "/PublishSuccessActivity/PublishSuccessActivity")
public class PublishSuccessActivity extends BaseActivity implements PublishSuccessContract.View {
    @Inject
    PublishSuccessPresenter presenter;
    ...
    private void initView() {
        ...
        DaggerPublishSuccessActivityComponent.builder()
                .appComponent(getAppComponent())
                .publishSuccessPresenterModule(new PublishSuccessPresenterModule(this, MainDataManager.getInstance(mDataManager)))
                .build()
                .inject(this);
