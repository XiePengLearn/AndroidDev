 ...
 * @Description:
 */
public class StoreWebFragmentPresenter extends BasePresenter implements StoreWebFragmentContract.Presenter {

    private MainDataManager mDataManager;

    private StoreWebFragmentContract.View mContractView;
    private static final String TAG = "BeforePagePresenter";

    @Inject
    public StoreWebFragmentPresenter(MainDataManager mDataManager, StoreWebFragmentContract.View view) {
