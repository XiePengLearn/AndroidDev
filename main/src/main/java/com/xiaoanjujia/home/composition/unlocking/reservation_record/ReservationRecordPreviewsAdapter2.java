...
public class ReservationRecordPreviewsAdapter2 extends BaseQuickAdapter<VisitingRecordsResponse.DataBean, BaseViewHolder> {
    ...
    public ReservationRecordPreviewsAdapter2(int layoutResId) {
        super(layoutResId);
    }


    @Override
    protected void convert(BaseViewHolder helper, final VisitingRecordsResponse.DataBean info, int position) {
